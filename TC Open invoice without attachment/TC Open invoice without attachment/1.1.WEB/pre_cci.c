# 1 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c"
...
# 1 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
...
# 2 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
...
# 3 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
...
# 4 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
...
Action()
{
	...
	web_url("authorize", 
		"URL=https://procurepartestc1.authentication.sap.hana.ondemand.com/oauth/authorize", 
		"Resource=0", 
		"RecContentType=text/html", 
	...
	lr_start_transaction("invoice_open");

	(web_remove_auto_header("X-Requested-With", "ImplicitGen=Yes", "LAST"));

	(web_remove_auto_header("X-XHR-Logon", "ImplicitGen=Yes", "LAST"));
	...
	lr_end_transaction("invoice_open", 2);

	return 0;
}
# 5 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
...
# 6 "d:\\dev\\vuser_scripts\\1.1.web\\\\combined_1.1.WEB.c" 2
